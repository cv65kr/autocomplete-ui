...
var ErrorWithMessage_1 = __webpack_require__(3);
/**
...
exports.__esModule = true;
var tslib_1 = __webpack_require__(0);
var InvalidFormatError_1 = __webpack_require__(2);
var Coordinate_1 = __webpack_require__(10);
...
var Aggregation_1 = __webpack_require__(24);
var Filter_1 = __webpack_require__(6);
var Filter_2 = __webpack_require__(6);
var Aggregation_2 = __webpack_require__(24);
var InvalidFormatError_1 = __webpack_require__(2);
var Filter_3 = __webpack_require__(6);
var ScoreStrategies_1 = __webpack_require__(47);
var SortBy_1 = __webpack_require__(25);
var IndexUUID_1 = __webpack_require__(49);
/**
 * Query constants
 */
...
exports.__esModule = true;
var tslib_1 = __webpack_require__(0);
var Apisearch_1 = __webpack_require__(79);
...
exports.__esModule = true;
var Item_1 = __webpack_require__(7);
var ResultAggregations_1 = __webpack_require__(27);
/**
 * Result class
 */
...
exports.__esModule = true;
var ResultAggregation_1 = __webpack_require__(55);
/**
...
exports.__esModule = true;
var tslib_1 = __webpack_require__(0);
var axios_1 = __webpack_require__(80);
var __1 = __webpack_require__(21);
var Client_1 = __webpack_require__(43);
var Response_1 = __webpack_require__(23);
/**
 * AxiosClient
 */
...
exports.__esModule = true;
var Retry_1 = __webpack_require__(45);
/**
 * Http class
 */
...
exports.__esModule = true;
var ScoreStrategy_1 = __webpack_require__(48);
/**
...
exports.__esModule = true;
var tslib_1 = __webpack_require__(0);
var ConnectionError_1 = __webpack_require__(51);
var InvalidFormatError_1 = __webpack_require__(2);
var InvalidTokenError_1 = __webpack_require__(52);
var ResourceExistsError_1 = __webpack_require__(53);
var ResourceNotAvailableError_1 = __webpack_require__(54);
var UnknownError_1 = __webpack_require__(99);
var Response_1 = __webpack_require__(23);
var Index_1 = __webpack_require__(100);
var Item_1 = __webpack_require__(7);
var ItemUUID_1 = __webpack_require__(11);
var Result_1 = __webpack_require__(26);
...
var tslib_1 = __webpack_require__(0);
var Filter_1 = __webpack_require__(6);
var Counter_1 = __webpack_require__(56);
/**
 * ResultAggregation class
 */
...
exports.__esModule = true;
var Metadata_1 = __webpack_require__(57);
/**
 * Aggregation class
 */
...
var _apisearch = __webpack_require__(21);

var _apisearch2 = _interopRequireDefault(_apisearch);

var _unistore = __webpack_require__(110);

var _unistore2 = _interopRequireDefault(_unistore);

var _render = __webpack_require__(111);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports = function (clientCredentials) {
    var client = _apisearch2.default.createRepository(clientCredentials);
...
exports.__esModule = true;
var tslib_1 = __webpack_require__(0);
var AxiosClient_1 = __webpack_require__(37);
var RetryMap_1 = __webpack_require__(44);
var Query_1 = __webpack_require__(9);
var Query_2 = __webpack_require__(9);
var Query_3 = __webpack_require__(9);
var SortBy_1 = __webpack_require__(25);
var HttpRepository_1 = __webpack_require__(50);
var Result_1 = __webpack_require__(26);
var ResultAggregations_1 = __webpack_require__(27);
var Transformer_1 = __webpack_require__(59);
/**
 * Apisearch class
 */
...
var InvalidFormatError_1 = __webpack_require__(2);
var IndexUUID_1 = __webpack_require__(49);
var AppUUID_1 = __webpack_require__(101);
/**
 * Index class
 */
...
exports.__esModule = true;
var Synonym_1 = __webpack_require__(60);
...
var _preact2 = __webpack_require__(28);

var _InputComponent = __webpack_require__(112);

var _InputComponent2 = _interopRequireDefault(_InputComponent);

var _ResultComponent = __webpack_require__(114);
...
var renderInput = exports.renderInput = function renderInput(_ref) {
    ...
    (0, _preact.render)((0, _preact.h)(
        _preact2.Provider,
        { store: store },
        (0, _preact.h)(_InputComponent2.default, { htmlNodeInheritProps: getNodeAttributes(targetNode) })
...
var renderResult = exports.renderResult = function renderResult(_ref2) {
    ...
    var resultComponent = (0, _preact.h)(
        _preact2.Provider,
        { store: store },
        (0, _preact.h)(_ResultComponent2.default, null)
    );
 ...
 * @constructor
 */
var InputComponent = exports.InputComponent = function InputComponent(_ref) {
 ...
 * Input connector
 */
var ConnectedInput = (0, _preact2.connect)('', _actions.actions)(InputComponent);

exports.default = ConnectedInput;
...
var actions = exports.actions = function actions(store) {
    return {
        ...
        searchAction: function searchAction(state, event) {
             ...
             * Compose query
             */
            var query = _Query.Query.create(queryText, 1, state.itemsPerResult).filterByTypes(datasetKeys).enableHighlights();

            /**
             * Empty query OR
             * Query length smaller than min keywords
             */
            if (query.getQueryText === '' || query.getQueryText.length < state.startSearchOn) {
             ...
             * Search data
             */
            state.client.query(query).then(function (result) {
        ...
        keyDownAction: function keyDownAction(state, event) {
            if (event.code === key.enter) {
                if (state.currentCursorIndex !== 0) {
                     ...
                     */
                    document.querySelector("li[data-index='" + state.currentCursorIndex + "'] a").click();
                }
            }
            ...
            if (event.code === key.down) {
                var currentIndex = state.currentCursorIndex;
                var visibleHits = state.items.length;

                return {
                    currentCursorIndex: currentIndex < visibleHits ? currentIndex + 1 : 0
                };
            }
            ...
            if (event.code === key.up) {
                ...
                var _currentIndex = state.currentCursorIndex;
                var _visibleHits = state.items.length;
                return {
                    currentCursorIndex: _currentIndex > 0 ? _currentIndex - 1 : _visibleHits
                };
            }
        },
         ...
         * @param event
         */
        focusOutAction: function focusOutAction(_ref, event) {
...
var _groupBy = __webpack_require__(115);
 ...
 * @constructor
 */
var ResultComponent = exports.ResultComponent = function ResultComponent(_ref) {
    ...
    var filteredItemsByType = (0, _helpers.createDatasetByItemTypeAndSetActiveIndex)(items, currentCursorIndex);
        ...
        Object.keys(filteredItemsByType).map(function (type) {
            return (0, _preact.h)(
                ...
                filteredDatasetsByType[type][0].template.header ? (0, _preact.h)('div', {
                    ...
                    dangerouslySetInnerHTML: (0, _helpers.renderTemplate)(filteredDatasetsByType[type][0].template.header, null)
                }) : null,
                (0, _preact.h)(
                    'ul',
                    {
                    ...
                    filteredItemsByType[type].map(function (item, index) {
                        return (0, _preact.h)('li', {
                            'data-index': item.navigationIndex,
                            className: 'as-result__datasetItem' + (item.isActive ? ' as-result__datasetItem--active' : ''),
                            dangerouslySetInnerHTML: (0, _helpers.renderTemplate)(filteredDatasetsByType[type][0].template.item, item)
                        });
                    })
                )
            );
        }),
        (0, _helpers.buildPoweredBy)(poweredBy)
    );
};
 ...
 * Result connector
 */
var ConnectedResult = (0, _preact2.connect)('datasets, poweredBy, resultBoxOpen, currentCursorIndex, items')(ResultComponent);

exports.default = ConnectedResult;
...
var baseAssignValue = __webpack_require__(116),
    createAggregator = __webpack_require__(124);
...
var arrayAggregator = __webpack_require__(125),
    baseAggregator = __webpack_require__(126),
...
exports.buildPoweredBy = exports.createDatasetByItemTypeAndSetActiveIndex = exports.renderTemplate = undefined;
...
var _hogan = __webpack_require__(208);
 ...
 * @param data
 */
var renderTemplate = exports.renderTemplate = function renderTemplate(template, data) {
 ...
 * @returns {{}}
 */
var createDatasetByItemTypeAndSetActiveIndex = exports.createDatasetByItemTypeAndSetActiveIndex = function createDatasetByItemTypeAndSetActiveIndex(items, currentCursorIndex) {
    var sortedItemsByType = (0, _lodash.sortBy)(items, 'uuid.type');
    var itemsWithActiveIndex = sortedItemsByType.map(function (item, index) {
    ...
    return (0, _lodash.groupBy)(itemsWithActiveIndex, 'uuid.type');
};
 ...
 * @returns {XML}
 */
var buildPoweredBy = exports.buildPoweredBy = function buildPoweredBy() {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(63), __webpack_require__(31)(module)))
...
var Hogan = __webpack_require__(209);
Hogan.Template = __webpack_require__(210).Template;
...
//# sourceMappingURL=apisearch-autocomplete.js.map