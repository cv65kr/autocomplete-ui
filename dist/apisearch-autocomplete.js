...
var actions = exports.actions = function actions(store) {
    return {
        ...
        searchAction: function searchAction(state, queryText) {
            var query = state.client.query.create(queryText).filterByTypes(state.datasets).enableHighlights();
...
var _hogan = __webpack_require__(9);
    ...
    return (0, _preact.h)(
        ...
        datasets.map(function (dataset) {
            return (0, _preact.h)(
                "ul",
                null,
                dataset.template.header ? (0, _preact.h)("li", {
                    dangerouslySetInnerHTML: {
                        __html: renderTemplate(dataset.template.header, null)
                    }
                }) : null,
                data.items.map(function (item) {
                    return item.uuid.type === dataset.type ? (0, _preact.h)("li", {
                        dangerouslySetInnerHTML: {
